# MMP项目上下文快照
> 生成时间: 2025-09-24T10:28:46.736904
> 生成器版本: 1.0
...
- **project_context_generator.py**: 1个类, 1个函数, 528行
  > 项目上下文快照生成器
为大语言模型多轮会话提供完整的项目理解上下文
- **project_context_generator_old.py**: 1个类, 1个函数, 423行
  > 项目上下文快照生成器
为大语言模型多轮会话提供完整的项目理解上下文
...
更新关键词映射，改进医疗器械识别能力
- **api.py**: 0个类, 1个函数, 33行
- **project_context_generator_v2.py**: 1个类, 1个函数, 542行
  > 项目上下文快照生成器
为大语言模型多轮会话提供完整的项目理解上下文
...
## 🔄 最近变更
- project_context_generator_v2.py (2025-09-24T10:26:52.441149)
- project_context_generator.py (2025-09-24T10:24:19.734562)
...
- project_context_generator_old.py (2025-09-24T10:11:21.957931)
