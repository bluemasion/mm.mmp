# MMP项目上下文快照
> 生成时间: 2025-09-24T10:12:31.462625
> 生成器版本: 1.0
...
- **test_database_functionality.py**: 0个类, 5个函数, 230行
  > 数据库功能验证脚本
测试MMP系统的数据库连接和基本功能
- **project_context_generator_fixed.py**: 1个类, 1个函数, 440行
  > 项目上下文快照生成器
...
## 🔄 最近变更
- project_context_generator_fixed.py (2025-09-24T10:12:16.234969)
- project_context_generator.py (2025-09-24T10:11:21.957931)
